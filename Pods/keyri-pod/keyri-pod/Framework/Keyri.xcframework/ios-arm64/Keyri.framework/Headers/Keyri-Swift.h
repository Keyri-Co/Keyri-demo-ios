...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER SWIFT_DEPRECATED_MSG("Use init with detectionsConfig argument instead");
- (nonnull instancetype)initWithAppKey:(NSString * _Nonnull)appKey publicApiKey:(NSString * _Nullable)publicApiKey serviceEncryptionKey:(NSString * _Nullable)serviceEncryptionKey detectionsConfig:(KeyriDetectionsConfig * _Nonnull)detectionsConfig OBJC_DESIGNATED_INITIALIZER;
- (void)initializeKeyriWithAppKey:(NSString * _Nonnull)appKey publicApiKey:(NSString * _Nullable)publicApiKey serviceEncryptionKey:(NSString * _Nullable)serviceEncryptionKey blockEmulatorDetection:(BOOL)blockEmulatorDetection SWIFT_DEPRECATED_MSG("Use init with detectionsConfig argument instead");
...
- (void)getCorrectedTimestampSecondsWithCompletion:(void (^ _Nonnull)(NSInteger))completion;
...
- (void)confirmWithPayload:(NSString * _Nonnull)payload trustNewBrowser:(BOOL)trustNewBrowser completion:(void (^ _Nonnull)(NSError * _Nullable))completion completionHandler:(void (^ _Nonnull)(void))completionHandler;
- (void)denyWithPayload:(NSString * _Nonnull)payload completion:(void (^ _Nonnull)(NSError * _Nullable))completion completionHandler:(void (^ _Nonnull)(void))completionHandler;
@end
